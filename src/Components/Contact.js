            ...
            <div className='contact--container'>
             ...
             <div className="contact--form">
                ...
                <div className="success" style={{display: success?"block":"none"}}>Your message is successfully sent!</div>
                    ...
                    <button type="submit" style={{borderRadius: "5px", width:"150px", height:"35px", border:"2px solid black", backgroundColor: "transparent", textDecoration:"underline"}}>Send</button>
