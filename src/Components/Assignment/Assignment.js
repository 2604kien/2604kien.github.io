...
export default function Assignment(){
    ...
    return(
        <div className="assLayout">
            ...
            <p>- Students draw sea creatures with crayons during a literacy unit "under the sea" and paint blue backgrounds to blend visual arts with storytelling activities.</p>
            ...
            <p>• Practical Classroom Activity: </p>
            <p>- The “Make a Mood Palette” activity serves as a tool to analyze emotions through Visual Arts.</p>
            <p>- Students first read “The Color Monster” together then create a mood wall for the class by mixing paint colours to represent different emotions before integrating emotional understanding with artistic expression.</p>
            ...
            <p>• Practical Classroom Activity: </p>
            <p>- Use the lesson “Exploring Patterns Through Dance.” </p>
            ...
            <p>- Apply “Creative Dance in the Early Years” to construct a movement lesson inspired by Where the Wild Things Are.</p>
            <p>- Integrated Activity Idea: </p>
            <p>Children physically narrate the story through movement after reading it. Students bring Max and the Wild Things to life through different levels from low to high as well as big and small shapes combined with varying tempos that are slow and fast. Students work in small teams to develop a brief movement routine that illustrates Max’s adventure and then perform it for their classmates.</p>
            ...
            <p>• Practical Classroom Activity (enhanced): </p>
            <p>- A “Freeze It” video helps students develop their dance awareness and control of their body movements.</p>
            <p>- Integrated Activity Idea: </p>
            <p>Students dance freely to upbeat music. Students freeze their movement in either an emotional expression like happiness or anger or a physical shape like wide or tall when the music ends. The teacher asks students to either describe their pose or demonstrate it differently after each freeze round. Students use movement in an activity that connects social-emotional learning with their ability to express themselves orally.</p>
            ...
            <p>• Practical Classroom Activity (enhanced): </p>
            <p>- Utilize “The Magic Carpet” episode as a tool for movement exploration during a guided fantasy journey.</p>
            <p>- Integrated Activity Idea: </p>
            ...
            <p>• Practical Classroom Activity:</p>
            <p>• Use the “Magic Door” game: The Magic Door game inspires children to imagine entering an alternate world after opening a door.</p>
            <p>• Integrated Activity Idea: This activity will connect directly to a science unit about different habitats. The children select a habitat behind their door which might be a jungle, desert, or ocean and demonstrate an animal from that environment. The other kids make their best guesses and describe the surroundings.</p>
            <p>• Learning Outcome:</p>
            ...
            <p>•	Integrated Activity Idea: In a science unit about lifecycles, students use clay or paper cut-outs to animate the stages of a butterfly’s life using stop-motion apps like Stop Motion Studio.</p>
